...
const PopularProducts = () => {
  return (
    <section id="products" className="max-container max-sm:mt-12 ml-4 mr-4">
      ...
      <div className="mt-16 grid border-2 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 sm:gap-4 gap-14">
        {
